  ...
  return (
    <div style={{ background: 'var(--color-canvas)', minHeight: '100vh', fontFamily: "'Hanken Grotesk'" }}>
      ...
      <main style={{ maxWidth: 720, margin: '0 auto', padding: '60px 44px', textAlign: 'center' }}>
        {/* Warning icon */}
        <div style={{ width: 78, height: 78, borderRadius: '50%', background: 'var(--color-alert-bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 26px', fontSize: 32 }}>⚠</div>

        <div style={{ fontFamily: "'Spline Sans Mono',monospace", fontSize: 11, letterSpacing: '.16em', textTransform: 'uppercase', color: 'var(--color-alert)', marginBottom: 14 }}>
        ...
        <p style={{ fontSize: 15.5, color: 'var(--color-body)', lineHeight: 1.65, maxWidth: 520, margin: '0 auto 30px' }}>
        ...
        <div style={{ display: 'flex', gap: 14, maxWidth: 520, margin: '0 auto 34px' }}>
          {[
            ...
            <div key={label} style={{ flex: 1, background: 'var(--color-surface)', border: '1px solid var(--color-hairline)', borderRadius: 14, padding: 18 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}>
                ...
                <span style={{ fontFamily: "'Newsreader',serif", color: 'var(--color-alert)' }}>{conf}%</span>
              </div>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <button style={{ background: 'var(--color-ink)', color: 'var(--color-canvas)', border: 'none', borderRadius: '999px', padding: '15px 28px', fontFamily: "'Hanken Grotesk'", fontWeight: 600, fontSize: 15, cursor: 'pointer' }}>
