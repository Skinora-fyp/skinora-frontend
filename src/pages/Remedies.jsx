  ...
  return (
    <div style={{ background: 'var(--color-canvas)', minHeight: '100vh', fontFamily: "'Hanken Grotesk'" }}>
      ...
      <main style={{ maxWidth: 1120, margin: '0 auto', padding: '44px 40px 72px' }}>
        ...
        {/* ── Medical disclaimer ── */}
        <div style={{ marginTop: 20, background: 'var(--color-alert-bg)', border: '1px solid color-mix(in srgb, var(--color-alert-strong) 25%, transparent)', borderRadius: 14, padding: '16px 20px', display: 'flex', gap: 12, alignItems: 'flex-start' }}>
